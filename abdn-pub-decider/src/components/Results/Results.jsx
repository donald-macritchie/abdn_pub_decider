    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center mt-6 p-6 text-center">
          <h3 className="karla text-xl font-bold">Make your way to...</h3>
          <h1 className="souvenir text-3xl mt-8 p-8">
            {selectedPub?.name || "Spin to find out!"}
          </h1>
        </div>
        <div>
          <div className="flex flex-col items-center justify-center p-2">
            <p className="border-2 border-[#E86BA5] rounded-xl p-2 karla text-lg w-30 text-center">
              Address
            </p>
            <p className="mt-4 font-bold text-xl karla text-center">
              {selectedPub?.address || ""}
            </p>
          </div>
          <div className="flex flex-col items-center justify-center mt-8 p-2">
            <p className="border-2 border-[#6AC1CC] rounded-xl p-2 karla text-lg w-30 text-center">
              Area
            </p>
            <p className="mt-4 font-bold karla text-center text-xl">
